...
parser.add_argument('--trained_model', default='/media/aimenext/Newdisk/cuongdx/ufj/models/2021_01_23_22_56_2.0/1117_23.833.pth', type=str, help='pretrained model')
...
parser.add_argument('--test_folder', default='/home/aimenext/cuongdx/ufj/data/all', type=str, help='folder path to input images')
parser.add_argument('--refine', default=False, type=str2bool, help='enable link refiner')
parser.add_argument('--refiner_model', default=None, type=str, help='pretrained refiner model')
